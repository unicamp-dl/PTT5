...
python3 t5_assin.py assin2_ptt5_large_long --model_name ptt5-custom-vocab-large --vocab_name t5-large --bs 1 --architecture long --max_epochs 50 --debug
...
python3 t5_assin.py assin2_ptt5_large_entail --model_name ptt5-custom-vocab-large --vocab_name t5-large --bs 1 --architecture categoric --max_epochs 50 --nout 2 --debug
