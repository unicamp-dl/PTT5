# 2pochs large
python3 t5_assin.py assin2_ptt5_large_entail_custom_vocab_10p_2poch --gpu 0 --model_name ptt5-custom-vocab-large-2poch --vocab_name custom --bs 1 --architecture categoric --max_epochs 50 --nout 2 --patience 10 --checkpoint_path ../checkpoints --model_path exp7 --log_path exp7
