...
python3 t5_assin.py assin2_ptt5_large_long --model_name ptt5-standard-vocab-large --vocab_name t5-large --bs 1 --architecture long --max_epochs 50 --checkpoint_path checkpoints --model_path models --log_path logs
...
python3 t5_assin.py assin2_ptt5_large_entail --model_name ptt5-standard-vocab-large --vocab_name t5-large --bs 1 --architecture categoric --max_epochs 50 --nout 2 --checkpoint_path checkpoints --model_path models --log_path logs
